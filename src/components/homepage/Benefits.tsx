        ...
        <div className="px-5 md:px-10">
            <div className="max-w-[80rem] w-full mx-auto py-14">
                <div className="flex flex-col text-center">
                    <div className="flex flex-col mx-auto my-12 items-center justify-center max-w-[47rem]">
                        <h2
                    ...
                    <div className="grid gri-col-1fr md:grid-cols-[1fr,1fr,1fr] auto-cols-[1fr] justify-center items-center mx-auto gap-10">
                        <motion.div
