...
const AboutHomeBody = () => {
    ...
    return (
        <>
            <div>
                <BackButton onClick={() => router.push("/host/interested")} />
            </div>
            <div className="mx-auto w-full max-w-[80rem] pb-[4.5rem]">
                <div className="flex flex-col justify-center pt-4 text-left">
                    ...
                    <p className="mb-8 mt-4 text-xl font-light opacity-70">
                        We&apos;re excited to learn about your home! Your
                        progress is saved after each screen in case you need to
                ...
                <form className="grid grid-cols-[1fr,1fr] grid-rows-[1fr] gap-x-6 gap-y-0">
                    <div className="col-span-2 row-span-1 block">
                        ...
                        >
                            Location
                            <p className="font-light">City, state, country</p>
                            <input
                    ...
                    <div className="col-span-2 row-span-1 block">
                        ...
                        <label className="mb-8 flex items-center">
                            ...
                            <input
                                type="text"
                                className="border-b-solid m-4 ml-2 border-b border-[#C5D1CF] focus:border-green focus:outline-none focus:ring-0 focus-visible:border-green"
                            />
                        </label>
                    </div>
                    ...
                    <div className="col-span-2 row-span-1 block">
                        ...
                        <label className="mb-2 mt-6 flex">
                            <input
                                ...
                                className="mr-2 font-light"
                            />
                            My home is accessed via an elevator
                        </label>
                        <label className="mb-8 mt-6 flex items-center">
                            <input
                                type="radio"
                                name="homeType"
                                value="other"
                                className="mr-2"
                            />
                            N/A - my home is on the ground floor
                        </label>
                    </div>
                    <div className="col-span-2 row-span-1 block">
                        <label
                    ...
                    <div className="col-span-2 row-span-1 mt-4 flex flex-col transition duration-200 ease-in-out hover:scale-105">
                        <button
                            ...
                            onClick={() => router.push("/host/more-info")}
                        >
                            Next
                        </button>
                    </div>
