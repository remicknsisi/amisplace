        ...
        <div className="px-5 md:px-8 lg:px-16">
            <div className="mx-auto w-full max-w-[80rem]">
                <div className="grid-cols-1fr mb-28 grid items-center justify-center gap-x-10 gap-y-12 pt-16 lg:grid-cols-[1fr,1fr]">
                    ...
                    <div className="absolute bottom-0 left-auto right-0 top-0 z-[-1] h-[75rem] opacity-100 md:h-[80rem] lg:h-full">
                        <div className="relative right-0 h-full w-[56rem] md:-right-[130px] md:right-0">
                            <img
                                src="/assets/decorative-ring.svg"
                                alt="Background ring"
                                className={`h-full w-full origin-top transform object-cover transition-opacity transition-transform duration-1000 duration-1000 md:object-left-top ${
                                    isLoaded
